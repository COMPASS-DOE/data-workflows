...
# These must be named "NEWVAR_[new_research_name]", where "new_research_name" is
# given in the new variables CSV files
# Functions must return the data frame they're given, with "value" and "units" columns added
# (Optional: "OOB" column)
...
f <- function(dir_name, dirs_to_process, out_dir) {
    ...
    for(i in seq_len(nrow(nvt))) {
        ...
        dat_subset[rn_needed] <- NULL  # drop old research names
