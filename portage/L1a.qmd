...
f <- function(dir_name, dirs_to_process, out_dir) {
    ...
    # 1. CSV file defines list of derived variables and what they need
    # 2. Code isolates data needed, puts into wide form
    #       just site, plot, tree, timestamp, research_name, value
    # 3. Function (called based on name in CSV file) is called, returns new values
    #       and new assigned design_link and research_name
